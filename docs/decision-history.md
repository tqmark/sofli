...
Messages  Finder    BT1      BT2       Notes     OLED on   Esc
...
- Hold K+B/T/C/S/X/G/N to open Browser, Ghostty, Chat, Settings, Messages, Finder, or Notes.
...
- Native Space+B/T/N/C/S/M/F simultaneous chords open Browser, terminal, Notes, Chat, Settings, Messages, and Finder. They use a 30 ms window and explicitly exclude the Sofle device (VID `0x1d50`, PID `0x615e`) plus Ghostty and Apple Terminal.
- The Sofle emits F13-F19 from Raise. Karabiner maps them to Browser, Ghostty/Terminal, Notes, Chat, Settings, Messages, and Finder. This keeps application launching away from F1-F12 and avoids Space/Shift ambiguity on the Sofle.
