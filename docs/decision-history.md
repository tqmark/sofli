...
- The design below is merged into main and installed on both Sofles at firmware revision `9b9d69e`; physical typing/comfort tests on the new version are still pending.
